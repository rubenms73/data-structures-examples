...
demo folder. Demo06 also includes optional C++, C# and Python versions.
...
- [A stack in Java, C++, C# and Python](Demo06StacksAcrossLanguages/README.md).

Demo06 can be read after Topic 1 to compare interfaces, generic programming and
