...
public final class ExampleChecks
{
    ...
    public static void main(String[] args)
    {
        ...
        rejects(NullPointerException.class, () -> new MyLinkedList<Integer>((Integer[]) null));
        rejects(NullPointerException.class, () -> new MyLinkedList<Integer>((Collection<Integer>) null));
        List<Number> copy = new MyLinkedList<>(list);
        copy.set(0, 2.5);
        equal(1, list.get(0));
        ...
        for (int trial = 0; trial < 100; trial++)
        {
            ...
            List<Integer> actual = new MyLinkedList<>(expected);
