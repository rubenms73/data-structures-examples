...
public final class ExampleChecks
{
    ...
    private static <E> void verify(RedBlackTree<E> tree, TreeSet<E> oracle)
    {
    ...
    {
        RedBlackTree<Integer> tree = new RedBlackTree<>(Comparator.naturalOrder());
        rejects(NullPointerException.class, () -> new RedBlackTree<Integer>(null));
        ...
        RedBlackTree<Integer> wider = new RedBlackTree<>(numeric);
        ...
        RedBlackTree<String> words = new RedBlackTree<>(String.CASE_INSENSITIVE_ORDER);
        check(words.add("Oak"));
        check(!words.add("OAK"));
